...
class Level6Quiz extends StatefulWidget {
  const Level6Quiz({Key? key}) : super(key: key);

  @override
  _Level6QuizState createState() => _Level6QuizState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: FutureBuilder<DocumentSnapshot>(
          future:
          FirebaseFirestore.instance.collection("quiz").doc("level 6").get(),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child:Column(
                                  children: [
                                    SizedBox(height: 30,),
                                    Image.network(choice1,height: 170,width: 150,fit: BoxFit.cover,),
                                  ],
                                )
                              ),
                            ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                  ...
                                  child:Column(
                                    children: [
                                      SizedBox(height: 30,),
                                      Image.network(choice2,height: 170,width: 150,fit: BoxFit.cover,),
                                    ],
                                  )
                              ),
                            ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                  ...
                                  child:Column(
                                    children: [
                                      SizedBox(height: 30,),
                                      Image.network(choice3,height: 170,width: 150,fit: BoxFit.cover,),
                                    ],
                                  )
                              ),
                            )
                        ...
                        Text("Note: Tap on the word to listen.",style: GoogleFonts.aBeeZee(
                          color: Colors.grey
                        ),),
                      ],
                    ),
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child:Column(
                                      children: [
                                        SizedBox(height: 30,),
                                        Image.network(choice2,height: 300,width: 250,fit: BoxFit.cover,),
                                      ],
                                    )
                                ),
                                SizedBox(
